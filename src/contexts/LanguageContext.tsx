...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "privacy.dataCollectionText": "We collect the following types of information:",
    "privacy.data1": "Contact information (name, email, phone number)",
    "privacy.data2": "Payment information (processed securely through third-party providers)",
    "privacy.data3": "Usage data (how you interact with our website)",
    "privacy.data4": "Device information (browser type, IP address)",
    "privacy.dataUsage": "How We Use Your Data",
    "privacy.dataUsageText": "Your data is used to:",
    "privacy.usage1": "Process and fulfill your orders",
    "privacy.usage2": "Provide customer support",
    "privacy.usage3": "Improve our services",
    "privacy.usage4": "Send important updates (with your consent)",
    "privacy.dataProtection": "Data Protection",
    "privacy.dataProtectionText": "We implement industry-standard security measures to protect your personal information. All payment transactions are encrypted and processed through secure payment gateways.",
    ...
    "refund.eligible3": "The refund request is made within 7 days of purchase",
    "refund.nonEligible": "Non-Refundable Items",
    "refund.nonEligibleText": "Refunds are not available for:",
    "refund.nonEligible1": "Products that have been used for more than 24 hours",
