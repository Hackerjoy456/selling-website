  ...
  return (
    <div className="container mx-auto px-4 py-12 md:py-20">
      ...
      <div className="text-center mb-20">
        ...
        <p className="text-xl md:text-2xl text-[#a9b0ff] max-w-3xl mx-auto font-medium leading-relaxed">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
        <div className="p-8 md:p-12 rounded-3xl bg-gradient-to-br from-[rgba(0,234,255,0.1)] to-[rgba(0,234,255,0.05)] border-2 border-[rgba(0,234,255,0.3)]">
          ...
          <p className="text-lg text-[#a9b0ff] leading-relaxed font-medium">
      ...
      {/* Values Section */}
      <div className="mb-20">
        <h2 className="text-4xl md:text-5xl font-black text-center mb-12 bg-gradient-to-r from-[#00eaff] to-[#ff4fd8] bg-clip-text text-transparent">
          Our Core Values
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            >
              ...
              <p className="text-[#a9b0ff] font-medium">{value.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {[
          ...
          >
            <div className="text-4xl md:text-5xl font-black mb-3 bg-gradient-to-r from-[#00eaff] to-[#ff4fd8] bg-clip-text text-transparent">
              {stat.number}
            </div>
            <div className="text-sm md:text-base text-[#a9b0ff] font-bold uppercase tracking-wider">
              {stat.label}
            </div>
          </div>
        ))}
